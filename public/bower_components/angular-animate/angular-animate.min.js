    ...
    f.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function () {
        ...
        T.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", function (O, M, I, U, x, C, P, S, V) {
            ...
            function W(a, c, b) {
                ...
                var f = [], k = [];
                g(c.classes, function (a, d) {
                    var b = m[d], c = e[d] || {};
                    !1 === a ? (b || "addClass" == c.event) && k.push(d) : !0 === a && (b && "removeClass" !=
                    c.event || f.push(d))
                });
            ...
            function y(a, c, b, e, m, k, p, F) {
                ...
                if (0 < r) {
                    r = [];
                    if (n.isClassBased)"setClass" == t.event ? (r.push(t), l(b, c)) : q[c] && (aa = q[c], aa.event == a ? m = !0 : (r.push(aa), l(b, c))); else if ("leave" ==
                        a && q["ng-leave"])m = !0; else {
            ...
            function Y(a, c) {
                ...
                do {
                    ...
                    g && (k = !0);
                    !1 !== b && (g = c.data("$$ngAnimateChildren"), f.isDefined(g) &&
                    (b = g));
            ...
            return {
                animate: function (a, c, b, e, g) {
                    ...
                    if (p)return e && l.options && (l.options =
                        f.extend(l.options || {}, e)), l.promise;
        ...
        B.register("", ["$window", "$sniffer", "$timeout", "$$animateReflow", function (t, B, I, U) {
            ...
            function J(a, d, b, c, e) {
                ...
                if (-1 != m.getAttribute("class").indexOf(b) && a) {
                    ...
                    if (0 < t) {
                        s = 0;
                        0 < v.transitionDelay &&
                        0 === v.transitionDuration && (s = v.transitionDelay * t);
                        var y = 0;
                    ...
                    if (0 === x)d.removeClass(q), K(d, b), c(); else {
                        ...
                        var t = Math.max(D.transitionDelay,
                            D.animationDelay), A = 1E3 * t;
            ...
            return {
                animate: function (a,
                    ...
                    if (f = Q("setClass", a, b, f.from))return C(a, e), f;
                    x();
                    e()
